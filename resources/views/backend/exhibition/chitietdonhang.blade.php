            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm">
                  <form role="search" method="get" id="searchform" action="{{route('Exhibition.searchchitietdonhang')}}">
                    <input type="text" value="" id="s" name="key" placeholder="Nhập từ khóa..." />
                    <button class="fa fa-search btn btn btn-sm btn-success" type="submit" id="searchsubmit"></button>
                  </form>
                </div>    
              </div>
            </div>
